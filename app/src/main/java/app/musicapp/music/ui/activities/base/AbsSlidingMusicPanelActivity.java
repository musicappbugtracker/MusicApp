package app.musicapp.music.ui.activities.base;
...
import app.musicapp.music.ui.fragments.player.MiniPlayerFragment;
import app.musicapp.music.ui.fragments.player.NowPlayingScreen;
import app.musicapp.music.ui.fragments.player.card.CardPlayerFragment;
import app.musicapp.music.ui.fragments.player.flat.FlatPlayerFragment;
    ...
    private void animateNavigationBarColor(int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            navigationBarColorAnimator = ValueAnimator
                    ...
                    .setDuration(ViewUtil.MUSIC_APP_ANIM_TIME);
