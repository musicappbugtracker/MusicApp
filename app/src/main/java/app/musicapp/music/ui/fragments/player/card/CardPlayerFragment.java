package app.musicapp.music.ui.fragments.player.card;
...
import app.musicapp.music.adapter.song.PlayingQueueAdapter;
import app.musicapp.music.dialogs.LyricsDialog;
...
import app.musicapp.music.ui.fragments.player.AbsPlayerFragment;
import app.musicapp.music.ui.fragments.player.PlayerAlbumCoverFragment;
...
import app.musicapp.music.views.WidthFitSquareLayout;
...
public class CardPlayerFragment extends AbsPlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    ...
    private static abstract class BaseImpl implements Impl {
        ...
        public AnimatorSet createDefaultColorChangeAnimatorSet(int newColor) {
            ...
            animatorSet.setDuration(ViewUtil.MUSIC_APP_ANIM_TIME);
            return animatorSet;
        }
